    ...
    <div className="min-h-screen bg-black flex items-center justify-center p-4">
      <Card className="w-full max-w-md bg-gray-900 border-red-800">
        <CardHeader className="text-center">
          <CardTitle className="text-2xl font-bold text-red-500">Sign Up</CardTitle>
          <CardDescription className="text-gray-400">Create an account or use Google to get started</CardDescription>
        </CardHeader>
