    ...
    <div className="min-h-screen bg-black flex items-center justify-center p-4">
      <Card className="w-full max-w-md bg-gray-900 border-red-800">
        <CardHeader className="text-center">
          <CardTitle className="text-2xl font-bold text-red-500">Sign In</CardTitle>
          <CardDescription className="text-gray-400">Enter your credentials or use Google to sign in</CardDescription>
        </CardHeader>
